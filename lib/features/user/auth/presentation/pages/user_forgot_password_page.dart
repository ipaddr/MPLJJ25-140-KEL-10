  ...
  Future<void> _requestPasswordReset() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        // 2. Get user data including phone number
        final userDoc = userQuerySnapshot.docs.first;
        _userId = userDoc.id;
        _phoneNumber = userDoc.data()['phoneNumber'];

        if (_phoneNumber == null || _phoneNumber!.isEmpty) {
          throw Exception('User account does not have a phone number.');
        }
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Masukkan email Anda untuk menerima kode OTP reset kata sandi',
                        style: TextStyle(
                          fontSize: 14,
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Kode OTP akan dikirim ke nomor telepon yang terdaftar dengan email ini.',
                                  style: TextStyle(
                                    fontSize: 12,
